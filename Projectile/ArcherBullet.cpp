...
ArcherBullet::ArcherBullet(float x, float y, float damage, const Engine::Point &direction, float rotation, float maxDist)
    : Projectile("Projectiles/ArcherBullet.png", 0.0f, damage, Engine::Point(x, y), direction, rotation, nullptr),
      maxDist(maxDist)
{
...
void ArcherBullet::Update(float deltaTime)
{
